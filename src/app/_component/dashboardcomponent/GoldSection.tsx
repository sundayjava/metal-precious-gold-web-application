    ...
    <div className="mt-16 bg-white">
      <div className="flex md:flex-row flex-col justify-between gap-2 items-center">
        <div className="md:w-[60%] w-full">
          ...
          <Link href="https://www.youtube.com/watch?v=qySv9Yw2SuQ" className="mt-4 gap-2 flex items-center md:justify-start justify-end text-primaryColor text-[15px] text-center">
      ...
      <div className="gap-10 items-center flex md:flex-row flex-col justify-between mt-12">
        ...
        <div className="md:w-[50%] w-full">
          ...
          <div className="mt-11">
          <Link href="en/about-us" className="text-primaryColor hover-border font-normal mt-11">
